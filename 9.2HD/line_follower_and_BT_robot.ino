...
{  
  ...
  // else if(bt_data == 10){mode=2; Stop();}    //Manual Android Application Control Command
  ...
  { 
    ...
    if (input.startsWith("Forward")) {
        command = "Forward";
        durationStr = input.substring(7);
    } else if (input.startsWith("Backward")) {
        command = "Backward";
        durationStr = input.substring(8);
    } else if (input.startsWith("Right")) {
        command = "Right";
        durationStr = input.substring(5);
    } else if (input.startsWith("Left")) {
        command = "Left";
        durationStr = input.substring(4);
    }
